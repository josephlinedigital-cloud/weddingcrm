    ...
    <main className="login-page">
      <section className="login-card">
        ...
        <div className="login-form-card">
          <h2>Sign in</h2>
          {!configured && <div className="alert">Add the Supabase values from <code>.env.example</code> to <code>.env.local</code> before signing in.</div>}
          ...
          <form action={login} className="login-form">
            ...
            <button className="button button-primary login-submit" type="submit" disabled={!configured}>Sign in</button>
          </form>
